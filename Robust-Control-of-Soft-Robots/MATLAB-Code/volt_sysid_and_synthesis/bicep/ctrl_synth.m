...
%% performance
% % ss
rectangle('Position',[1e-1 50 0.05 0], 'LineWidth',1);

% % tracking
rectangle('Position',[1e-1 0 0.9 30], 'LineWidth',1);

% % tracking 2
rectangle('Position',[1e-1 0 3.9 20],'LineWidth',1);

% % tracking 3
rectangle('Position',[1e-1 0 9.9 10],'LineWidth',1);
% 
% % bandwidth
rectangle('Position',[35 -5 0 10], 'LineWidth',1);

% % disturbance rejection
rectangle('Position',[100 -10 500 10], 'LineWidth',1);

% % disturbance rejection
rectangle('Position',[200 -20 500 20], 'LineWidth',1);
%%
...
f7 = figure(7)
s = tf('s');
sys_tricep = load('tricep_tfs.mat')
hold on
for m = 1:8
